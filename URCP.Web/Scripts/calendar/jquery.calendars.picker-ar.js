...
(function($) {
	$.calendarsPicker.regionalOptions['ar'] = {
		...
		prevText: '<span class="icon icon-arrow-left-12"></span>', prevStatus: 'عرض الشهر السابق',
		prevJumpText: '&#x3c;&#x3c;', prevJumpStatus: '',
		nextText: '<span class="icon icon-arrow-right-12"></span>', nextStatus: 'عرض الشهر القادم',
