  ...
  Chosen = (function() {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      container_div = $("<div />", {
        ...
        style: 'max-width: ' + this.f_width + 'px;'
      });
      if (this.is_multiple) {
    ...
    Chosen.prototype.choice_build = function(item) {
      ...
      this.choices += 1;
      this.search_container.before('<li class="search-choice" id="' + choice_id + '"><span>' + item.html + '</span><a href="javascript:void(0)" class="search-choice-close icon icon-remove-circle-1" rel="' + item.array_index + '"></a></li>');//&#9421;
    ...
    Chosen.prototype.no_results = function(terms) {
      var no_results_html;
      no_results_html = $('<li class="no-results">"<span></span>"</li>');//No results match 
