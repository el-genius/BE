...
(function($) {
	$.calendarsPicker.regionalOptions['en-GB'] = {
		...
		prevText: '<span class="icon icon-arrow-left-12"></span>', prevStatus: 'Show the previous month',
		prevJumpText: '&lt;&lt;', prevJumpStatus: 'Show the previous year',
		nextText: '<span class="icon icon-arrow-right-12"></span>', nextStatus: 'Show the next month',
