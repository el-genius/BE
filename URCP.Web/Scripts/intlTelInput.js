...
(function (factory) {
   ...
   ********************/
        ...
        isValidNumber: function () { 
            ...
            var res = false; 
            if (this.selectedCountryData.iso2.toLowerCase() == "sa") {
                if ($(this).attr('telInput').hasClass('phone-number')) {
                    res = validateSaudiNumber(val);
                } else {
                    res = validateSaudiFax(val);
                }
            } else {
                res = window.intlTelInputUtils ? intlTelInputUtils.isValidNumber(val, countryCode) : null;
            }
            return res;
        },
...
function validateSaudiNumber(v) {
    var re = /^(009665|9665|\+9665|05|5)(5|0|3|6|4|9|1|8|7)([0-9]{7})$/;
    return re.test(v);
}

function validateSaudiFax(v) {
    var re = /^(009661|9661|\+9661|1)(1|2|3|4|6|7)([0-9]{7})$/;
    return re.test(v);
}