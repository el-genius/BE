...
namespace URCP.GraphDiff.Internal
{
    /// <summary>
    /// Entity creation, type & key management
    /// </summary>
    internal interface IEntityManager
    {
        ...
        /// <summary>
        /// Creates an empty object of the same type and keys matching the entity provided
        /// </summary>
        object CreateEmptyEntityWithKey(object entity);

        /// <summary>
        /// Returns true if the keys of entity1 and entity2 match.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves the navigation properties for the given type
        /// </summary>
    ...
    internal class EntityManager : IEntityManager
    {
        ...
        private string GetEntitySetName(Type entityType)
        {
            ...
            {
                set = _objectContext.MetadataWorkspace
