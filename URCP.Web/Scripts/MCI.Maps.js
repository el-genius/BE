...
function loadGoogleMapsApi(callBackFnName, additionalParams) {
    if ((typeof google == 'undefined' || typeof google.maps == 'undefined')) {
        ...
        jQuery.getScript('https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDitojDZ5Zan2eQ4_bMEcIub_FVWp2QtwY&libraries=drawing&language=ar&region=sa&callback=googleMapsMainCallback' + additionalParams)
